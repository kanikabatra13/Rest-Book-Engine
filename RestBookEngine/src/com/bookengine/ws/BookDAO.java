...
public class BookDAO {
	...
	public BookDAO() {
			...
			Book book1 = new Book("1","Web Services","Kanika","567-789");
			Book book2= new Book("2","XML Programming","Julius","7890-567");
			Book book3= new Book("3","Database Programming","Yang","234-890");
